...
class Entity(Base):
    ...
    characters = relationship("Character", backref="entities")
...
class Character(Entity):
    ...
    players = relationship("Player", backref="characters")
    
    # Relationship to NPCs
    npcs = relationship("NPC", backref="characters")

    def __str__(self):
        return f"Character(id={self.id}, inventory_id={self.inventory_id}, type={self.type}, race={self.race}, stats={self.stats}, properties={self.character_properties})"

class Player(Character):
    __tablename__ = 'players'
    id = Column(Integer, primary_key=True, unique=True)
    character_id = Column(Integer, ForeignKey('Character.id'), unique=True)
    inventory_id = Column(Integer, ForeignKey('inventories.id'), unique=True)
    name = Column(String)
    ...
    # Relationship to Character
    characters = relationship("Character", back_populates="players")

    def __str__(self):
        return f"Player(id={self.id}, character_id={self.character_id}, inventory_id={self.inventory_id},  player_name={self.name}, stats={self.stats}, level={self.level}, experience={self.experience}, player_properties={self.player_properties}, log={self.log})"
...
class NPC(Character):
    ...
    unit_class = Column(String, nullable=True)
    ...
    def __str__(self):
        return f"NPC(id={self.id}, character_id={self.character_id}, inventory_id={self.inventory_id}, name={self.name}, unit_class={self.unit_class}, unit_name={self.unit_name}, unit_affiliation={self.unit_affiliation}, stats={self.stats}, level={self.level}, experience={self.experience}, properties={self.properties})"        
...
class Group(Entity):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, unique=True)
    group_id = Column(Integer, ForeignKey('entity.id'), autoincrement=True)
...
class Inventory(Container):
    ...
    container_id = Column(Integer, ForeignKey('containers.id'), autoincrement=True, unique=True)
    inventory_id = Column(Integer, primary_key=True, autoincrement=True)
    owner_id = Column(Integer, ForeignKey('characters.id'), unique=True)
